# Generated by Django 4.2.2 on 2023-07-26 15:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('consultations', '0010_alter_day_consultation_stop'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='day_consultation',
            name='societe',
            field=models.CharField(choices=[('CARENA', 'CARENA'), ('REGIE', 'REGIE'), ('PRESTATAIRE', 'PRESTATAIRE'), ('AGENT DE BORD', 'AGENT DE BORD')], max_length=50),
        ),
        migrations.AlterField(
            model_name='day_consultation',
            name='stop',
            field=models.CharField(blank=True, choices=[('Avec arret', 'Avec arrêt'), ('Sans arret', 'Sans arrêt')], default='', max_length=100),
        ),
        migrations.AlterField(
